...
- [x] (UI) catálogo origens/campanhas — Fase **4.2b**; ver [`frontend-vue-spec.md`](./frontend-vue-spec.md) §4.2b
...
Catálogo de origens/campanhas (Fase **4.2b**) **não** inclui `spend_amount` / CAC de ads (B+). **Próximo no front:** PWA (Fase 5).
