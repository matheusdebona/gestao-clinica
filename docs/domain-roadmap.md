...
- [x] **UI catalog** origins/campaigns (CRUD screens + ClientForm shortcuts) — Vue phase **4.2b**; spec: [`frontend-vue-spec.md`](./frontend-vue-spec.md) §4.2b; GET index/show = permissão **A** (`*.manage|clients.create|clients.update`)

**DoD:** clients usable as sale/budget counterparts. Catalog UI for origins/campaigns is Vue Fase 4.2b (API + UI shipped).
...
- [x] **Origens e campanhas** (catálogo UI, atalhos no ClientForm, GET permissão A para quem cria/edita cliente) — Fase **4.2b**; ver [`frontend-vue-spec.md`](./frontend-vue-spec.md) §4.2b
